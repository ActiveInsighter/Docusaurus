...
其实 dijkstra 算法 和 我们之前讲解的prim算法思路非常接近，如果大家认真学过[prim算法](https://programmercarl.com/kamacoder/0053.寻宝-prim.html)，那么理解 Dijkstra 算法会相对容易很多。（这也是我要先讲prim再讲dijkstra的原因）
...
我在[prim算法](https://programmercarl.com/kamacoder/0053.寻宝-prim.html)讲解中也给出了三部曲。 prim 和 dijkstra 确实很像，思路也是类似的，这一点我在后面还会详细来讲。
...
这里还是有一些“坑”的，本题打印路径和 prim 打印路径是一样的，我在[prim算法精讲](https://programmercarl.com/kamacoder/0053.寻宝-prim.html)【拓展】中 已经详细讲解了。
...
> 这里再次提示，需要先看我的[prim算法精讲](https://programmercarl.com/kamacoder/0053.寻宝-prim.html)，否则可能不知道我下面讲的是什么。
