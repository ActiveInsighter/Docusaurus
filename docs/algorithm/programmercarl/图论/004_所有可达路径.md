...
我在讲解[二叉树理论基础](https://programmercarl.com/%E4%BA%8C%E5%8F%89%E6%A0%91%E7%90%86%E8%AE%BA%E5%9F%BA%E7%A1%80.html)的时候，提到过，**二叉树的前中后序遍历其实就是深搜在二叉树这种数据结构上的应用**。
...
在[图论理论基础篇](https://programmercarl.com/kamacoder/图论理论基础.html) 中我们讲到了 两种 图的存储方式：邻接表 和 邻接矩阵。
...
我在 [图论理论基础篇](https://programmercarl.com/kamacoder/图论理论基础.html) 举了一个例子：
...
本题是深度优先搜索的基础题目，关于深搜我在[图论深搜理论基础](https://programmercarl.com/kamacoder/图论深搜理论基础.html) 已经有详细的讲解，图文并茂。

关于本题我会直接使用深搜三部曲来分析，如果对深搜不够了解，建议先看 [图论深搜理论基础](https://programmercarl.com/kamacoder/图论深搜理论基础.html)。
...
为什么要有回溯，我在[图论深搜理论基础](https://programmercarl.com/kamacoder/图论深搜理论基础.html) 也有详细的讲解。
