...
[动态规划：关于01背包问题，你该了解这些！](https://programmercarl.com/algo/dynamic-programming/zero-one-knapsack-basics-part-1.html)中，我们开始介绍了背包问题。
...
[动态规划：关于01背包问题，你该了解这些！（滚动数组）](https://programmercarl.com/algo/dynamic-programming/zero-one-knapsack-basics-part-2.html)中把01背包的一维dp数组（滚动数组）实现详细讲解了一遍。
...
[动态规划：416. 分割等和子集](https://programmercarl.com/algo/dynamic-programming/0416-partition-equal-subset-sum.html)中我们开始用01背包来解决问题。
...
[动态规划：1049. 最后一块石头的重量 II](https://programmercarl.com/algo/dynamic-programming/1049-last-stone-weight-ii.html)这道题目其实和[动态规划：416. 分割等和子集](https://programmercarl.com/algo/dynamic-programming/0416-partition-equal-subset-sum.html)是非常像的。

本题其实就是尽量让石头分成重量相同的两堆，相撞之后剩下的石头最小，这样就化解成01背包问题了。

[动态规划：416. 分割等和子集](https://programmercarl.com/algo/dynamic-programming/0416-partition-equal-subset-sum.html)相当于是求背包是否正好装满，而本题是求背包最多能装多少。
